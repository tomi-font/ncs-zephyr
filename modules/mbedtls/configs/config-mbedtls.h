...
#include CONFIG_TF_PSA_CRYPTO_CONFIG_FILE

#if defined(CONFIG_MBEDTLS_USER_CONFIG)
#define MBEDTLS_USER_CONFIG_FILE CONFIG_MBEDTLS_USER_CONFIG_FILE
#endif
...
#if defined(CONFIG_MBEDTLS_X509_RSASSA_PSS_SUPPORT)
